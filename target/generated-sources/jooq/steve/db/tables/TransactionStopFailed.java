...
public class TransactionStopFailed extends TableImpl<TransactionStopFailedRecord> {
     ...
     */
    public final TableField<TransactionStopFailedRecord, String> CHARGE_BOX_ID = createField(DSL.name("charge_box_id"), SQLDataType.VARCHAR(255), this, "");
     ...
     */
    public final TableField<TransactionStopFailedRecord, TransactionStopFailedEventActor> EVENT_ACTOR = createField(DSL.name("event_actor"), SQLDataType.VARCHAR(7).asEnumDataType(TransactionStopFailedEventActor.class), this, "");
