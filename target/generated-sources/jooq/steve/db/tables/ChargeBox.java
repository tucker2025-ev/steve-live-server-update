...
public class ChargeBox extends TableImpl<ChargeBoxRecord> {
    ...
    /**
     * The column <code>stevedb.charge_box.supports_offline_charging</code>.
     */
    public final TableField<ChargeBoxRecord, Boolean> SUPPORTS_OFFLINE_CHARGING = createField(DSL.name("supports_offline_charging"), SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.inline("0", SQLDataType.BOOLEAN)), this, "");
