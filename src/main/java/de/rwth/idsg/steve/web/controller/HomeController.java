...
public class HomeController {
    ...
    private static final String CHARGE_POINT_STATUS = HOME_PREFIX + "/chargePointStatus";
    ...
    public String getHome(Model model) {
        ...
        model.addAttribute("AvailableCount", homeService.onlineChargePoint().size());
        model.addAttribute("UnAvailableCount", homeService.offlineChargePointFind().size());
        return "home";
    }
    ...
    public String getConnectorStatusQuery(@ModelAttribute(PARAMS) ConnectorStatusForm params, Model model) {
        ...
        List<ConnectorStatus> filter = homeService.findCConnectedChargeBoxConnectors(filteredList);

        model.addAttribute("connectorStatusList", filter);
        return "connectorStatus";
    }

    @RequestMapping(value = OCPP_JSON_STATUS)
    public String getOcppJsonStatus(Model model) {
        model.addAttribute("ocppJsonStatusList", homeService.onlineChargePoint());
        return "ocppJsonStatus";
    }


    @RequestMapping("/chargePointStatus/offline")
    public String showOnlineList(Model model) {
        List<OcppJsonStatus> offlineList = homeService.offlineChargePointFind();
        model.addAttribute("chargePoints", offlineList);
        model.addAttribute("status", "Online");
        return "chargePointStatusList";
    }


    @RequestMapping("/chargePointStatus/charger")
    public String showWssChargerList(Model model) {
        List<OcppJsonStatus> offlineList = homeService.offlineChargePointFind();
        model.addAttribute("chargePoints", offlineList);
        model.addAttribute("status", "Online");
        return "chargePointStatusList";
    ...
    @RequestMapping("/chargePointStatus/charger/available")
    public String showWssAvailableChargerList(Model model) {
        List<OcppJsonStatus> offlineList = homeService.offlineChargePointFind();
        model.addAttribute("chargePoints", offlineList);
        model.addAttribute("status", "Online");
        return "chargePointStatusList";
    ...
    @RequestMapping(value = "/chargePointStatus/charger/Unavailable")
    public String showWssUnAvailableChargerList(Model model) {
        List<OcppJsonStatus> offlineList = homeService.offlineChargePointFind();
        model.addAttribute("chargePoints", offlineList);
        model.addAttribute("status", "Online");
        return "chargePointStatusList";
...
//    @RequestMapping(value = "ws" + OCPP_JSON_STATUS)
//    public String getAnotherServerOcppJsonStatus(Model model) {
//        model.addAttribute("ocppJsonStatusList", homeService.retrieveServerChargerDetails());
//        return "ocppJsonStatus";
//    }
