...
public class Keys {
    ...
    public static final UniqueKey<LiveChargingDataRecord> KEY_LIVE_CHARGING_DATA_TRANSACTION_ID = Internal.createUniqueKey(LiveChargingData.LIVE_CHARGING_DATA, DSL.name("KEY_live_charging_data_transaction_id"), new TableField[] { LiveChargingData.LIVE_CHARGING_DATA.TRANSACTION_ID }, true);
