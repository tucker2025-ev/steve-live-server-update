...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${ctxPath}/static/css/logfiletable.css">
...
<div class="main">
    <div class="top-banner">
        <div class="container">
            <a href="${ctxPath}/manager/home"><img src="${ctxPath}/static/images/Tuckerlogo.png" height="80"></a>
        </div>
    </div>
    <div class="top-menu">
        <div class="container">
                                       ...
                                       <li>
                                           <div class="dropdown">
                                                                   ...
                                                                   <div class="dropdown-content">
                                                                     <a href="${ctxPath}/manager/log" style="color:#000">Log File</a>
                                                                     <a href="${ctxPath}/manager/websocket-logs"  style="color:#000">Log Table</a>
                                                                   </div>
                                            </div>
                                       </li>
                    <li><a href="${ctxPath}/manager/about">ABOUT</a></li>
                    <li>
                        <form action="${ctxPath}/manager/signout" method="post" style="display:inline;">
                            <input type="hidden"
                                   name="${_csrf.parameterName}"
                                   value="${_csrf.token}" />

                            <button type="submit"
                                    style="background:none;border:none;color:white;cursor:pointer; margin-top:10px !important;">
                                SIGN OUT
                            </button>
                        </form>
                    </li>
