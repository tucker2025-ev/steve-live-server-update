...
<%@ include file="00-header.jsp" %>
	<div class="content">
		<div class="tileWrapper">
			...
			<div class="tileRow1">
				 ChargePoint Details
				<a href="${ctxPath}/manager/home/ocppJsonStatus" style="text-decoration: none;">
					<span class="baseTable">
						<span class="baseRow">
							<span class="baseCell">Available :</span>
							<span class="baseCell formatNumber"> ${AvailableCount}</span>
						</span></a>
				<a href="${ctxPath}/manager/chargePointStatus/offline" style="text-decoration: none;">
					<span class="baseRow">
						<span class="baseCell">UnAvailable :</span>
						<span class="baseCell formatNumber"> ${UnAvailableCount}</span>
					</span>
				</a>
