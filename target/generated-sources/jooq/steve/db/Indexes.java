...
public class Indexes {
    ...
    public static final Index TRANSACTION_ENERGY_MISMATCH_LOG_IDX_CHARGE_BOX = Internal.createIndex(DSL.name("idx_charge_box"), TransactionEnergyMismatchLog.TRANSACTION_ENERGY_MISMATCH_LOG, new OrderField[] { TransactionEnergyMismatchLog.TRANSACTION_ENERGY_MISMATCH_LOG.CHARGE_BOX_ID }, false);
    public static final Index TRANSACTION_ENERGY_MISMATCH_LOG_IDX_CREATED_AT = Internal.createIndex(DSL.name("idx_created_at"), TransactionEnergyMismatchLog.TRANSACTION_ENERGY_MISMATCH_LOG, new OrderField[] { TransactionEnergyMismatchLog.TRANSACTION_ENERGY_MISMATCH_LOG.CREATED_AT }, false);
    public static final Index TRANSACTION_ENERGY_MISMATCH_LOG_IDX_TRANSACTION_ID = Internal.createIndex(DSL.name("idx_transaction_id"), TransactionEnergyMismatchLog.TRANSACTION_ENERGY_MISMATCH_LOG, new OrderField[] { TransactionEnergyMismatchLog.TRANSACTION_ENERGY_MISMATCH_LOG.TRANSACTION_ID }, false);
